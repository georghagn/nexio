...
|----|----|
|![GSF-Suite-Logo](logo-suite.png)| ***GSF-Suite***<br>GSF is a collection of small, independent Go modules for building **simple services**. Member of **Go Simple Frameworks Suite**|

### Overview

GSF is a collection of small, independent Go modules for building **simple services**.
...
GSF (Go Simple Frameworks) provides a set of minimal infrastructure building blocks for microservices and service-oriented systems.
