...
Key Features:
  ...
  - Internal `io.Writer`: The package gsflog offer 3 io.Writer implemntations:
    ...
    (see pkg/gsflog/writer/lockwriter).
    ...
    handle (see pkg/gsflog/writer/reopen).

    -- Rotator: It is the default io.Writer implementation for gsflog. Used as
    inline-process it offers the fastest and safest write-strategy
    (see pkg/gsflog/rotate).
